...
public class CsvUtil {
    ...
    public static Stream<CsvRow> load(String file, String separator, int ignoreFirstNRows) throws IOException {
        return load(new FileInputStream(file), separator, ignoreFirstNRows);
    }

    public static Stream<CsvRow> load(InputStream stream, String separator, int ignoreFirstNRows) throws IOException {
