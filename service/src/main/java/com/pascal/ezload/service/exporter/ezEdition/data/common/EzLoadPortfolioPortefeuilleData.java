...
public interface EzLoadPortfolioPortefeuilleData {
    ...
    String ezLoad_portefeuille_eligibilityDeduction40 = "ezload.portefeuille.eligibilitéAbbatement40";
    ...
    String ezLoad_portefeuille_quantity = "ezload.portefeuille.quantité";
