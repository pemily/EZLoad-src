package com.pascal.bientotrentier.bourseDirect.extract;

import com.pascal.bientotrentier.MainSettings;
import com.pascal.bientotrentier.bourseDirect.BourseDirectSettings;
import com.pascal.bientotrentier.bourseDirect.BourseDirectAccount;
...
public class BourseDirectExtractor extends SeleniumUtil {

    private static final Logger logger = Logger.getLogger(BourseDirectExtractor.class);

    private final MainSettings mainSettings;
    private final BourseDirectSettings bourseDirectSettings;

    public BourseDirectExtractor(MainSettings mainSettings) {
    ...
    public void start() {
        ...
        try {
            driver = SeleniumUtil.getLocalhostWebDriver(mainSettings);
